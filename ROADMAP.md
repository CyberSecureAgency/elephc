...
- [x] **`Phar` / `PharData` OOP API** — a baseline constructor/constants,
  ...
  `getContent()`, and ArrayAccess read/write/isset surface is implemented
  ...
  iterator support, non-string metadata values, persisted metadata/stub
  serialization, tar compression controls, and OpenSSL/private-key signing
  remain future work.
