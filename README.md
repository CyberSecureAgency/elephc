...
- **Types**: union types (`int|string`), nullable (`?int`), `never` return type, `iterable` pseudo-type, type casting, typed properties, typed function and method parameters and returns
