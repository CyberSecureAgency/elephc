...
pub(super) fn emit_aarch64(emitter: &mut Emitter) {
    ...
    emitter.instruction("b.eq __rt_json_decode_array_real_skip_ws_step");
    emitter.instruction("cmp w11, #9");
    emitter.instruction("b.eq __rt_json_decode_array_real_skip_ws_step");
    emitter.instruction("cmp w11, #10");
    emitter.instruction("b.eq __rt_json_decode_array_real_skip_ws_step");
    emitter.instruction("cmp w11, #13");
    emitter.instruction("b.ne __rt_json_decode_array_real_skip_ws_done");
    emitter.label("__rt_json_decode_array_real_skip_ws_step");
    emitter.instruction("add x9, x9, #1");
    emitter.instruction("b __rt_json_decode_array_real_skip_ws");
    ...
    emitter.instruction("b.eq __rt_json_decode_array_real_close");
    ...
    emitter.instruction("ldrb w15, [x11, x9]");
    emitter.instruction("cbnz x14, __rt_json_decode_array_real_scan_after_escape");
    emitter.instruction("cbnz x13, __rt_json_decode_array_real_scan_in_string");
    // Outside string state.
    emitter.instruction("cmp w15, #34");                                        // '"'
    emitter.instruction("b.eq __rt_json_decode_array_real_scan_enter_string");
    emitter.instruction("cmp w15, #91");                                        // '['
    emitter.instruction("b.eq __rt_json_decode_array_real_scan_open");
    emitter.instruction("cmp w15, #123");                                       // '{'
    emitter.instruction("b.eq __rt_json_decode_array_real_scan_open");
    emitter.instruction("cmp w15, #93");                                        // ']'
    emitter.instruction("b.eq __rt_json_decode_array_real_scan_close");
    emitter.instruction("cmp w15, #125");                                       // '}'
    emitter.instruction("b.eq __rt_json_decode_array_real_scan_close");
    emitter.instruction("cmp w15, #44");                                        // ','
    emitter.instruction("b.ne __rt_json_decode_array_real_scan_advance");
    // Comma at depth 0 means element separator; bail.
    emitter.instruction("cbz x12, __rt_json_decode_array_real_scan_done");
    emitter.instruction("b __rt_json_decode_array_real_scan_advance");
    ...
    emitter.instruction("b.eq __rt_json_decode_array_real_scan_set_escape");
    ...
    emitter.instruction("add x9, x9, #1");
    emitter.instruction("b __rt_json_decode_array_real_scan");
    ...
    emitter.instruction("ldr x10, [sp, #8]");                                   // slice_len
    emitter.instruction("cmp x9, x10");
    emitter.instruction("b.ge __rt_json_decode_array_real_fail");
    emitter.instruction("ldrb w11, [x1, x9]");
    emitter.instruction("cmp w11, #44");                                        // ','
    emitter.instruction("b.eq __rt_json_decode_array_real_after_comma");
    emitter.instruction("cmp w11, #93");                                        // ']'
    emitter.instruction("b.eq __rt_json_decode_array_real_close");
    emitter.instruction("b __rt_json_decode_array_real_fail");

    emitter.label("__rt_json_decode_array_real_after_comma");
    emitter.instruction("add x9, x9, #1");
    emitter.instruction("str x9, [sp, #16]");
    emitter.instruction("b __rt_json_decode_array_real_loop");
...
pub(super) fn emit_x86_64(emitter: &mut Emitter) {
    ...
    emitter.instruction("je __rt_json_decode_array_real_skip_ws_step_x");
    emitter.instruction("cmp r8, 9");
    emitter.instruction("je __rt_json_decode_array_real_skip_ws_step_x");
    emitter.instruction("cmp r8, 10");
    emitter.instruction("je __rt_json_decode_array_real_skip_ws_step_x");
    emitter.instruction("cmp r8, 13");
    emitter.instruction("jne __rt_json_decode_array_real_skip_ws_done_x");
    emitter.label("__rt_json_decode_array_real_skip_ws_step_x");
    emitter.instruction("add rcx, 1");
    emitter.instruction("jmp __rt_json_decode_array_real_skip_ws_x");
    ...
    emitter.instruction("je __rt_json_decode_array_real_close_x");
    ...
    emitter.instruction("jge __rt_json_decode_array_real_scan_done_x");
    emitter.instruction("movzx r8, BYTE PTR [rax + rcx]");
    emitter.instruction("test r12, r12");
    emitter.instruction("jne __rt_json_decode_array_real_scan_after_escape_x");
    emitter.instruction("test r11, r11");
    emitter.instruction("jne __rt_json_decode_array_real_scan_in_string_x");
    // Outside string state.
    emitter.instruction("cmp r8, 34");                                          // '"'
    emitter.instruction("je __rt_json_decode_array_real_scan_enter_string_x");
    emitter.instruction("cmp r8, 91");                                          // '['
    emitter.instruction("je __rt_json_decode_array_real_scan_open_x");
    emitter.instruction("cmp r8, 123");                                         // '{'
    emitter.instruction("je __rt_json_decode_array_real_scan_open_x");
    emitter.instruction("cmp r8, 93");                                          // ']'
    emitter.instruction("je __rt_json_decode_array_real_scan_close_x");
    emitter.instruction("cmp r8, 125");                                         // '}'
    emitter.instruction("je __rt_json_decode_array_real_scan_close_x");
    emitter.instruction("cmp r8, 44");                                          // ','
    emitter.instruction("jne __rt_json_decode_array_real_scan_advance_x");
    ...
    emitter.instruction("jmp __rt_json_decode_array_real_scan_advance_x");
    ...
    emitter.instruction("je __rt_json_decode_array_real_scan_set_escape_x");
    ...
    emitter.instruction("add rcx, 1");
    emitter.instruction("jmp __rt_json_decode_array_real_scan_x");
    ...
    emitter.instruction("je __rt_json_decode_array_real_fail_x");
    ...
    emitter.instruction("jge __rt_json_decode_array_real_fail_x");
    emitter.instruction("movzx r8, BYTE PTR [rax + rcx]");
    emitter.instruction("cmp r8, 44");                                          // ','
    emitter.instruction("je __rt_json_decode_array_real_after_comma_x");
    emitter.instruction("cmp r8, 93");                                          // ']'
    emitter.instruction("je __rt_json_decode_array_real_close_x");
    emitter.instruction("jmp __rt_json_decode_array_real_fail_x");

    emitter.label("__rt_json_decode_array_real_after_comma_x");
    emitter.instruction("add rcx, 1");
    emitter.instruction("mov QWORD PTR [rbp - 24], rcx");
    emitter.instruction("jmp __rt_json_decode_array_real_loop_x");
