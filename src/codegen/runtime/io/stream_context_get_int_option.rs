...
pub fn emit_get_int_context_option(emitter: &mut Emitter) {
    ...
    emitter.instruction("cbz x0, __rt_gico_miss");
    ...
    emitter.instruction("b.eq __rt_gico_write");
    emitter.instruction("cmp x3, #3");                                          // tag 3 = bool
    emitter.instruction("b.ne __rt_gico_miss");
    ...
    emitter.instruction("b __rt_gico_done");
...
fn emit_get_int_context_option_linux_x86_64(emitter: &mut Emitter) {
    ...
    emitter.instruction("jz __rt_gico_miss_x86");
    ...
    emitter.instruction("je __rt_gico_write_x86");
    emitter.instruction("cmp rcx, 3");                                          // bool tag
    emitter.instruction("jne __rt_gico_miss_x86");
    ...
    emitter.instruction("jmp __rt_gico_done_x86");
